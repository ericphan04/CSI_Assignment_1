...
// Tao mang so nguyen có k phan tu co gia tri ngau nhien trong khoang tu m den n
...
// Ham tinh trung binh cong cua mot mang so nguyen ngau nhien giua m và n có k phan tu
...
// Hàm dem so lan xuat hien cua mot so cho truoc trong mng
